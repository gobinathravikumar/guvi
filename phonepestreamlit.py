...
conn = mysql.connector.connect(user='root', password='Gobi@7819', host="localhost", database="phonepe_pulse")
...
if SELECT == "Basic insights":
    ...
    if select == "Top 10 states based on year and amount of transaction":
        ...
        cursor.execute(
            "SELECT DISTINCT States,Transaction_year,SUM(Transaction_Amount) AS Amount FROM agg_tran GROUP BY States, Transaction_year ORDER BY Amount ASC LIMIT 10");
        df = pd.DataFrame(cursor.fetchall(), columns=['States', 'Transaction_year', 'Transaction_Amount'])
        col1, col2 = st.columns(2)
        with col1:
            st.write(df)
...
if SELECT == "Home":
    col1, col2, = st.columns(2)
    col1.image(Image.open("C:/Users/Lenovo/Downloads/phonepe.png"), width=500)
    with col1:
        st.subheader(
    ...
    with col2:
        st.video("C:/Users/Lenovo/Downloads/upi.mp4")
...
if SELECT == "About":
    col1, col2 = st.columns(2)
    with col1:
        st.video("C:/Users/Lenovo/Downloads/pulse-video.mp4")
    with col2:
        st.image(Image.open("C:/Users/Lenovo/Downloads/PhonePe_Logo.jpg"), width=500)
        st.write("---")
    ...
    with col1:
        ...
        st.image(Image.open("C:/Users/Lenovo/Downloads/top.jpeg"), width=400)
        with open("C:/Users/Lenovo/Downloads/annual report.pdf", "rb") as f:
            data = f.read()
        st.download_button("DOWNLOAD REPORT", data, file_name="annual report.pdf")
    with col2:
        st.image(Image.open("C:/Users/Lenovo/Downloads/report.jpeg"), width=800)

# ----------------------Contact---------------#


if SELECT == "Contact":
    name = "Gobinath Ravikumar"
    mail = (f'{"Mail :"}  {"gobinathravikumar@gmail.com"}')
    description = "An Aspiring DATA-SCIENTIST..!"
    social_media = {
        # "Youtube": "https://www.youtube.com/channel/UCHJz22G_3koWYX_7fwxaF0Q",
        "GITHUB": "https://github.com/gobinathravikumar",
        # "LINKEDIN": "https://www.linkedin.com/in/omkar-maurya/",
        "INSTAGRAM": "https://www.instagram.com/gobinathravikumar/"}
        # "Website": "https://omkarmaurya.website3.me/",
        # "Kaggle": "https://www.kaggle.com/omkarm0542"}

    col1, col2, col3 = st.columns(3)
    col3.image(Image.open("C:/Users/Lenovo/Downloads/photo.jpg"), width=350)
    with col2:
