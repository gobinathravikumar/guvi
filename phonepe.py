...
root_dir = (r'C:/Users/Lenovo/pulse/data')

# Initialize empty list to hold dictionaries of data for each JSON file
data_list = []

# Loop over all the state folders
for state_dir in os.listdir(os.path.join(root_dir, 'C:/Users/Lenovo/pulse/data/aggregated/transaction/country/india/state')):
    state_path = os.path.join(root_dir, 'C:/Users/Lenovo/pulse/data/aggregated/transaction/country/india/state', state_dir)
...
root_dir = 'C:/Users/Lenovo/pulse/data/aggregated/user/country/india/state'
df2_list = []
...
# Loop over all the state folders
for state_dir in os.listdir(os.path.join(root_dir, 'C:/Users/Lenovo/pulse/data/map/transaction/hover/country/india/state')):
    state_path = os.path.join(root_dir, 'C:/Users/Lenovo/pulse/data/map/transaction/hover/country/india/state', state_dir)
    if os.path.isdir(state_path):
...
root_dir = 'C:/Users/Lenovo/pulse/data/map/user/hover/country/india/state'
...
# Loop over all the state folders
for state_dir in os.listdir(os.path.join(root_dir, 'C:/Users/Lenovo/pulse/data/top/transaction/country/india/state')):
    state_path = os.path.join(root_dir, 'C:/Users/Lenovo/pulse/data/top/transaction/country/india/state', state_dir)
    if os.path.isdir(state_path):
...
root_dir = 'C:/Users/Lenovo/pulse/data/top/user/country/india/state'
